...
```bash
npm install @nahisaho/spread1000-assistant
```
...
```bash
npm uninstall @nahisaho/spread1000-assistant
```
...
npx @nahisaho/spread1000-assistant init

# Deno 方式 — スイート配備 + リポジトリクローン → VS Code MCP 設定
npx @nahisaho/spread1000-assistant init deno
```
