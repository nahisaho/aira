...
| [NatureLM](https://naturelm.github.io/) | Cross-domain (chemistry, life science, materials) | Natural-language-driven scientific entity generation | Drug discovery (ligand design, binding affinity optimization), protein design, materials design, RNA design — ⚠️ **NOT callable in AIRA environment — knowledge reference only** (cite arXiv:2502.07527 in Methods/Discussion; use classical baseline for local computation) |
