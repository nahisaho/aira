...
const translations = {
  ja: {
    ...
    'panel.skillRoutingHint': '各実行で同期されたスキルと、Copilot CLI が実際に読み込み・使用したスキルを記録します。',
  ...
  en: {
    ...
    'panel.skillRoutingHint': 'Records the skills synced into each run and which skills the Copilot CLI actually loaded / engaged.',
